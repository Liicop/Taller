    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-2 text-sm text-desc mb-6">
                ...
                <span class="text-title font-semibold">Nueva Cita</span>
            </div>
            ...
            <div class="mechanic-card">
                ...
                <div class="flex items-center gap-3 mb-8 pb-6 border-b border-[#23283b]">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-title">Nueva Cita de Servicio</h3>
                        <p class="text-sm text-desc">Seleccione su vehículo, fecha, hora y motivo de la visita.</p>
                    </div>
                </div>
