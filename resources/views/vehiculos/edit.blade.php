    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-2 text-sm text-desc mb-6">
                ...
                <span class="text-title font-semibold">Editar Vehículo</span>
            </div>
            ...
            <div class="mechanic-card">
                ...
                <div class="flex items-center gap-3 mb-8 pb-6 border-b border-[#23283b]">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-title">{{ $vehiculo->marca }}</h3>
                        <p class="text-sm text-desc">Placa: <span class="font-mono text-accent">{{ $vehiculo->placa }}</span> &mdash; Modelo {{ $vehiculo->modelo }}</p>
                    </div>
                </div>
