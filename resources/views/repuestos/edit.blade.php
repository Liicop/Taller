    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-2 text-sm text-desc mb-6">
                ...
                <span class="text-title font-semibold">Editar Repuesto</span>
            </div>
            ...
            <div class="mechanic-card">
                ...
                <div class="flex items-center gap-3 mb-8 pb-6 border-b border-[#23283b]">
                    ...
                    <div>
                        <h3 class="text-lg font-bold text-title">{{ $repuesto->nombre }}</h3>
                        <p class="text-sm text-desc">Código: <span class="font-mono text-accent">{{ $repuesto->codigo }}</span></p>
                    </div>
                </div>
                ...
                <form method="POST" enctype="multipart/form-data"
                    ...
                    <div class="space-y-4">
                        ...
                        @if ($repuesto->imagen)
                            <div class="flex items-center gap-4 p-4 rounded-xl bg-[#0f111a] border border-[#243c5a]">
                                <img
                                    src="{{ asset('storage/' . $repuesto->imagen) }}"
                                    alt="Imagen actual de {{ $repuesto->nombre }}"
                                    class="w-20 h-20 object-cover rounded-lg border border-[#23283b]"
                                >
                                <div>
                                    <p class="text-sm font-semibold text-title">Imagen actual</p>
                                    <p class="text-xs text-desc mt-1">Sube una nueva imagen para reemplazarla.</p>
                                </div>
                            </div>
                        @endif

                        <label for="imagen"
                               class="flex flex-col items-center justify-center w-full h-32 rounded-xl border-2 border-dashed border-[#243c5a]
                            ...
                            <span class="text-sm text-desc group-hover:text-accent transition-colors">
